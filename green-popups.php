...
define('LEPOPUP_VERSION', 7.05);
define('LEPOPUP_WEBFONTS_VERSION', 3);
define('LEPOPUP_EXPORT_VERSION', '0002');
define('LEPOPUP_API_URL', 'https://greenpopups.com/updates/');
...
//					'default' => array('value' => '', 'label' => esc_html__('Default value', 'lepopup'), 'tooltip' => esc_html__('The default value is the value that the field has before the user has entered anything.', 'lepopup'), 'type' => 'date'),
			...
			'rectangle' => array(
				'basic' => array('type' => 'tab', 'value' => 'basic', 'label' => esc_html__('Basic', 'lepopup')),
					'name' => array('value' => esc_html__('Rectangle / Image', 'lepopup'), 'label' => esc_html__('Name', 'lepopup'), 'type' => 'text'),
					'position' => array('value' => array('top' => '0', 'left' => '0'), 'caption' => array('top' => esc_html__('Top', 'lepopup'), 'left' => esc_html__('Left', 'lepopup')), 'label' => esc_html__('Position', 'lepopup'), 'tooltip' => esc_html__('Set the position of the element relative to the upper left corner of the base frame.', 'lepopup'), 'type' => 'top-left'),
		...
		$this->toolbar_tools = array(
			'text' => array(
				'title' => esc_html__('Text', 'lepopup'),
				'icon' => 'fas fa-pencil-alt',
				'type' => 'input'
			),
			'email' => array(
				'title' => esc_html__('Email', 'lepopup'),
				'icon' => 'far fa-envelope',
				'type' => 'input'
			),
			'number' => array(
				'title' => esc_html__('Number', 'lepopup'),
			...
			'textarea' => array(
				'title' => esc_html__('Textarea', 'lepopup'),
			...
			'date' => array(
				'title' => esc_html__('Date', 'lepopup'),
				'icon' => 'far fa-calendar-alt',
				'type' => 'input'
			),
			'time' => array(
				'title' => esc_html__('Time', 'lepopup'),
				'icon' => 'far fa-clock',
				'type' => 'input'
			),
			'file' => array(
			...
			'password' => array(
				'title' => esc_html__('Password', 'lepopup'),
				'icon' => 'fas fa-lock',
				'type' => 'input'
			),
			'signature' => array(
			...
			'rectangle' => array(
				'title' => esc_html__('Rectangle / Image', 'lepopup'),
				'icon' => 'far fa-square',
				'type' => 'other'
			),
			'html' => array(
	...
	function uploads_delete($_record_id, $_element_id = null) {
		global $wpdb;
		$uploads = $wpdb->get_results("SELECT * FROM ".$wpdb->prefix."lepopup_uploads WHERE deleted = '0' AND record_id = '".esc_sql($_record_id)."'".(!empty($_element_id) ? " AND element_id = '".esc_sql($_element_id)."'" : "")." AND upload_id = '' AND str_id = ''", ARRAY_A);
		$upload_dir = wp_upload_dir();
		...
		$wpdb->query("UPDATE ".$wpdb->prefix."lepopup_uploads SET deleted = '1' WHERE deleted = '0' AND record_id = '".esc_sql($_record_id)."'".(!empty($_element_id) ? " AND element_id = '".esc_sql($_element_id)."'" : "")." AND upload_id = '' AND str_id = ''");
	}
