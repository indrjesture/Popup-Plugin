...
class lepopup_omnisend_class {
	...
	function __construct() {
		$this->fields_meta = array(
			...
			'postalCode' => esc_html__('Postal Code', 'lepopup')
		);
		if (is_admin()) {
			add_filter('lepopup_providers', array(&$this, 'providers'), 10, 1);
			add_action('wp_ajax_lepopup-omnisend-settings-html', array(&$this, "admin_settings_html"));
		}
		add_filter('lepopup_integrations_do_omnisend', array(&$this, 'front_submit'), 10, 2);
	}
	
	function providers($_providers) {
		if (!array_key_exists("omnisend", $_providers)) $_providers["omnisend"] = esc_html__('Omnisend', 'lepopup');
		return $_providers;
	}
	...
	function admin_settings_html() {
		...
		if (current_user_can('manage_options')) {
			...
			<div class="lepopup-properties-item">
				...
				<div class="lepopup-properties-tooltip">
					...
					<div class="lepopup-tooltip-content">'.esc_html__('Enter your Omnisend API Key.', 'lepopup').'</div>
				</div>
				<div class="lepopup-properties-content">
					<input type="text" name="api-key" value="'.esc_html($data['api-key']).'" />
					<label class="lepopup-integrations-description">'.sprintf(esc_html__('Find your Omnisend API Key %shere%s.', 'lepopup'), '<a href="https://app.omnisend.com/#/my-account/integrations/api-keys" target="_blank">', '</a>').'</label>
				</div>
			</div>
			<div class="lepopup-properties-item">
				<div class="lepopup-properties-label">
				...
				<div class="lepopup-properties-tooltip">
					<i class="fas fa-question-circle lepopup-tooltip-anchor"></i>
					<div class="lepopup-tooltip-content">'.esc_html__('Map form fields to Omnisend fields.', 'lepopup').'</div>
				</div>
				<div class="lepopup-properties-content">
		...
		$html .= '				
			...
			<div class="lepopup-properties-item">
				...
				<div class="lepopup-properties-tooltip">
					<i class="fas fa-question-circle lepopup-tooltip-anchor"></i>
					<div class="lepopup-tooltip-content">'.esc_html__('Configure Omnisend custom fields and map form fields to them.', 'lepopup').'</div>
				</div>
				<div class="lepopup-properties-content">
...
$lepopup_omnisend = new lepopup_omnisend_class();
?>