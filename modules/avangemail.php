<?php
/* AvangEmail integration for Green Forms */
if (!defined('UAP_CORE') && !defined('ABSPATH')) exit;
class lepopup_avangemail_class {
	...
	function __construct() {
		if (is_admin()) {
			...
			add_action('wp_ajax_lepopup-avangemail-settings-html', array(&$this, "admin_settings_html"));
			add_action('wp_ajax_lepopup-avangemail-list', array(&$this, "admin_lists"));
			add_action('wp_ajax_lepopup-avangemail-fields', array(&$this, "admin_fields_html"));
			add_action('wp_ajax_lepopup-avangemail-groups', array(&$this, "admin_groups_html"));
		}
		add_filter('lepopup_integrations_do_avangemail', array(&$this, 'front_submit'), 10, 2);
	}
	
	function providers($_providers) {
		if (!array_key_exists("avangemail", $_providers)) $_providers["avangemail"] = esc_html__('AvangEmail', 'lepopup');
		return $_providers;
	}
		...
		if (current_user_can('manage_options')) {
			...
			<div class="lepopup-properties-item">
				...
				<div class="lepopup-properties-tooltip">
					...
					<div class="lepopup-tooltip-content">'.esc_html__('Enter your AvangEmail API Public Key.', 'lepopup').'</div>
				</div>
				<div class="lepopup-properties-content">
					<input type="text" name="public-key" value="'.esc_html($data['public-key']).'" />
					<label class="lepopup-integrations-description">Find your AvangEmail API Public Key <a href="https://avangemail.net/customer/api-keys/index" target="_blank">here</a>.</label>
				</div>
			</div>
			<div class="lepopup-properties-item">
				<div class="lepopup-properties-label">
				...
				<div class="lepopup-properties-tooltip">
					<i class="fas fa-question-circle lepopup-tooltip-anchor"></i>
					<div class="lepopup-tooltip-content">'.esc_html__('Enter your AvangEmail API Private Key.', 'lepopup').'</div>
				</div>
				<div class="lepopup-properties-content">
					<input type="text" name="private-key" value="'.esc_html($data['private-key']).'" />
					<label class="lepopup-integrations-description">Find your AvangEmail API Private Key <a href="https://avangemail.net/customer/api-keys/index" target="_blank">here</a>.</label>
				</div>
			</div>
			<div class="lepopup-properties-item">
				<div class="lepopup-properties-label">
			...
			<div class="lepopup-properties-item">
				...
				<div class="lepopup-properties-tooltip">
					<i class="fas fa-question-circle lepopup-tooltip-anchor"></i>
					<div class="lepopup-tooltip-content">'.esc_html__('Map form fields to AvangEmail fields.', 'lepopup').'</div>
				</div>
				<div class="lepopup-properties-content">
...
$lepopup_avangemail = new lepopup_avangemail_class();
?>